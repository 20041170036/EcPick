...
class EQConformer(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.kernel_sizes = [11, 9, 7, 5, 3]  # Kernel sizes for the convolutions
        ...
        self.transformer_d0 = ConformerBlock(
            dim=188,
            dim_head=8,
            heads=4,
            ff_mult=4,
            ...
            conv_kernel_size=3,
            attn_dropout=self.drop_rate,
            ff_dropout=self.drop_rate,
            conv_dropout=self.drop_rate
        )
        # self.transformer_d = ConformerBlock(
        #     dim=188,
        #     dim_head=8,
        #     heads=4,
        #     ff_mult=4,
    ...
    def forward(self, x):
        ...
        x = self.transformer_d0(x)
        # x = self.transformer_d(x)
...
class ResCNNBlock(nn.Module):
    def __init__(self, filters, ker, drop_rate):
        ...
        self.shrinkage = Shrinkage(filters, gap_size=(1))
    ...
    def forward(self, x):
        ...
        # return nn.ReLU(inplace=True)(x + y)
        return x + y
